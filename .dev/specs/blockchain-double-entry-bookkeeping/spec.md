...
- [ ] FR-2: 표준 Ethereum JSON-RPC (`eth_getLogs`, `eth_getBlockByNumber`, `eth_getTransactionReceipt`)를 사용하여 ETH, ERC-20, ERC-721, ERC-1155 전송 이력을 수집해야 한다 (MUST)
...
| API | 용도 | 비용 |
|-----|------|------|
| Ethereum JSON-RPC (eth_getLogs, eth_getBlockByNumber, eth_getTransactionReceipt) | Ethereum 트랜잭션 수집 | RPC 프로바이더에 따라 상이 |
